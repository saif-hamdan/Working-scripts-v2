...
const FORM_RESPONSE_TITLE_CANDIDATES = Object.freeze({
  ...
  CURRENT_DEPARTMENT: Object.freeze([FORM.TITLES.CURRENT_DEPARTMENT, 'القسم الحالي للموظف', 'القسم الحالي', 'القسم الحالي للموظف / Current Employee Section', 'Current Employee Section', 'Current Department']),
