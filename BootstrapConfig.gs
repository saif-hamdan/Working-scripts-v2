...
const BH = {
  DASHBOARD: ['الوحدة','القسم','رئيس الوحدة','بريد رئيس الوحدة','عدد المتدربين النشطين','الأرقام الوظيفية للمتدربين النشطين','جميع من تدربوا في القسم','آخر تاريخ تدريب','حالة القسم'],
  RECORDS: ['رقم الطلب','الطابع الزمني','بريد مقدم الطلب','المسؤول المباشر','بريد المسؤول المباشر','اسم الموظف','الرقم الوظيفي للموظف','بريد الموظف','الوحدة الحالية للموظف','رئيس الوحدة الحالية','بريد رئيس الوحدة الحالية','وحدة التدريب المطلوبة','القسم المطلوب','من تاريخ','إلى تاريخ','عدد ساعات التدريب اليومية','نوع الطلب','حالة موافقة رئيس الوحدة','حالة الاعتماد النهائي','سبب الرفض','رقم الطلب المتعارض','تفاصيل التعارض','تاريخ إرسال بريد الموافقة','تاريخ الرد','رابط التقييم','تم إرسال التقييم','تاريخ إرسال التقييم','آخر تحديث','ملاحظات','رمز الموافقة','بريد المعتمد','معرف رد النموذج','إصدار القفل','عدد محاولات البريد','آخر خطأ','معرف مصدر رد النموذج'],
