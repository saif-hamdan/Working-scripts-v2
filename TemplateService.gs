...
function buildTemplateData_(record, extra) {
  ...
  var rows = [
    ...
    { ar: 'وحدة التدريب المطلوبة', en: 'Requested Training Unit', value: record[H.RECORD.TRAINING_UNIT] },
    { ar: 'القسم المطلوب', en: 'Requested Section', value: record[H.RECORD.SECTION] },
    ...
    { ar: 'عدد ساعات التدريب اليومية', en: 'Daily Training Hours', value: record[H.RECORD.HOURS] },
